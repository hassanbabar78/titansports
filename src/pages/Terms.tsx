const Terms = () => (
  <div className="container mx-auto px-4 py-16 max-w-3xl">
    ...
    <div className="space-y-6 text-sm leading-relaxed">
      <section><h2 className="text-xl font-bold text-gold mb-2">1. About Titan Sports</h2>
        <p>Titan Sports sells <strong>physical boxing equipment</strong> only — including training, sparring, bag work, and competition gloves. We do not sell digital goods, services, or subscriptions.</p></section>
      ...
      <section><h2 className="text-xl font-bold text-gold mb-2">5. Intellectual Property</h2>
        <p>All content on this site — including the Titan Sports name, logo, product images, and copy — is owned by Titan Sports and protected by copyright and trademark laws.</p></section>
      <section><h2 className="text-xl font-bold text-gold mb-2">6. Dispute Resolution</h2>
        <p>Disputes will first be addressed via good-faith communication with our support team. Unresolved disputes are subject to the jurisdiction of the courts where Titan Sports is registered.</p></section>
      <section><h2 className="text-xl font-bold text-gold mb-2">7. Contact</h2>
        <p><span className="text-gold">support@titansports.com</span></p></section>
    </div>
  </div>
);
