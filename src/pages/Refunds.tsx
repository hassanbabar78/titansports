const Refunds = () => (
  <div className="container mx-auto px-4 py-16 max-w-3xl">
    <h1 className="text-3xl font-bold uppercase tracking-tight mb-6">Refund & Return Policy</h1>
    <div className="space-y-6 text-sm leading-relaxed">
      <section><h2 className="text-xl font-bold text-gold mb-2">30-Day Return Window</h2>
        <p>You may return any unused, unopened product in its original packaging within <strong>30 days</strong> of the delivery date for a full refund of the product price.</p></section>
      <section><h2 className="text-xl font-bold text-gold mb-2">Return Shipping</h2>
        <p>Customers are responsible for return shipping costs unless the product was damaged on arrival or shipped in error. We recommend using a trackable shipping service.</p></section>
